...
def test_find_overlapping_intervals_2():
    assert ([(1, 6)], [[8, 10], [15, 18]]) == mi.find_overlapping_interval_2(([], [[1, 3], [2, 6], [8, 10], [15, 18]]))
    assert ([[1, 3]], []) == mi.find_overlapping_interval_2(([], [[1, 3]]))
    assert ([[1, 3]], [[4, 6]]) == mi.find_overlapping_interval_2(([], [[1, 3], [4, 6]]))
    assert ([(1, 5)], []) == mi.find_overlapping_interval_2(([], [[1, 4], [4, 5]]))
